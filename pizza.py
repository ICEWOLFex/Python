...
def admins_menu(users_id):
    ...
    while(admin):
        ...
        if(choose=="1"):
            ...
            print("Баклажанов = " + str(data[4]))
            print("Охотничьих колбасок = " + str(data[5]))
            print("Сыра = " + str(data[6]))
            print("Пепперони = " + str(data[7]))
            ...
            if(chose == "y"):
                ...
                price+=45*threecount
                fourcount = int(input("Сколько закупить баклажанов? - "))
                price+=55*fourcount
                fivecount = int(input("Сколько закупить баварских калбасок? - "))
                price+=60*fivecount
                sixcount = int(input("Сколько закупить сыра? - "))
                price+=45*sixcount
                sevencount = int(input("Сколько закупить пепперони? - "))
                price+=70*sevencount
                onecount+=data[1]
                twocount+=data[2]
                threecount+=data[3]
...
def users_menu(users_id):
    ...
    while(user):
        ...
        if(choose == "1"):
            ...
            if(int(discont) >= 5000 and int(discont)<15000):
                price=price/100*5
            elif(int(discont) >= 15000 and int(discont)<25000):
                price=price/100*10
            elif(int(discont) >= 25000):
